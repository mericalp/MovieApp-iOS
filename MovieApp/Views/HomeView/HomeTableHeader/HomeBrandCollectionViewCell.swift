//
//  HomeBrandCollectionViewCell.swift
//  MovieApp
//
...
class HomeBrandCollectionViewCell: UICollectionViewCell {
    
    static let identifier = "HomeBrandCollectionViewCell"
    var images: [String]? {
        didSet {
...
extension HomeBrandCollectionViewCell: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
